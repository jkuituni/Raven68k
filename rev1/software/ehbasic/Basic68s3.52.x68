...
IVR   equ DUART+25      * Interrupt Vector Register (R/W)
	...
	ORG		$FF0000			* past the vectors in a real system
...
INIT_DUART
    lea     DUART,a0
    move.b  #$30,5(a0)       * Reset Transmitter
...
code_start
    lea     ram_base,SP  * Set our stack pointer to be sure
    bsr     INIT_DUART
...
LAB_SMSG
	...
	dc.b	'for the Raven68k computing project',$0D,$0A
	dc.b	'(Build: 0.0.2-rev1, 2021-02-29)',$0D,$0A,$00
